...
import fr.vmarchaud.mineweb.utils.regex.NamedMatcher;
import fr.vmarchaud.mineweb.utils.regex.NamedPattern;
...
public class RouteMatcher extends SimpleChannelInboundHandler<FullHttpRequest> {
	...
	public FullHttpResponse getResponseForRoute(ChannelHandlerContext ctx, FullHttpRequest request, List<PatternBinding> bindings) {
